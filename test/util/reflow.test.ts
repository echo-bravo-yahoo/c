...
describe('c > util > reflow', () => {
  ...
  describe('column visibility at various widths', () => {
    it('all 6 columns visible at wide terminal (200)', () => {
  ...
  describe('single-line snapshots', () => {
    it('wide terminal: columns have breathing room', () => {
      const sessions = [
        createTestSession({
          name: 'my-session',
          state: 'busy',
    ...
    it('minimum width: columns tight, content may truncate', () => {
      const sessions = [
        createTestSession({
    ...
    it('narrow: dropped columns do not appear in output', () => {
      const sessions = [
        createTestSession({
          name: 'hello',
          state: 'idle',
  ...
  describe('status column sizing', () => {
    it('status column fits tightly around longest status text', () => {
      const sessions = [
    ...
    it('status column grows for archived sessions', () => {
      const sessions = [
  ...
  describe('idName column', () => {
    it('ID is always 12 chars (8 id + padding)', () => {
      const sessions = [
        createTestSession({
          name: 'x',
          state: 'busy',
    ...
    it('short names get full display without truncation', () => {
      const sessions = [
        createTestSession({
          name: 'tiny',
          state: 'busy',
  ...
  describe('branch column with empty fallback', () => {
    it('no branch/worktree produces empty column content', () => {
      const sessions = [
        createTestSession({
          name: 'home-session',
          state: 'busy',
  ...
  describe('resource column', () => {
    it('PR number, JIRA, and tag all render when space allows', () => {
      const sessions = [
        createTestSession({
          name: 'full',
          state: 'busy',
  ...
  describe('consistency across rows', () => {
    it('all rows have same visual width at a given terminal width', () => {
      const sessions = [
        createTestSession({
          name: 'alpha-session',
          state: 'busy',
  ...
  describe('fixedWidth alignment', () => {
    ...
    it('exact-width text truncates (>= threshold)', () => {
