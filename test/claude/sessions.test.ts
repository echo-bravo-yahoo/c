...
describe('c > claude > sessions', () => {
  ...
  describe('project key round-trip', () => {
    it('encode then decode returns similar path (slashes)', () => {
  ...
  describe('session file structure', () => {
    it('identifies valid UUID session files', () => {
  ...
  describe('transcript parsing', () => {
    it('parses custom-title from JSONL', () => {
      const content = [
    ...
    it('returns last custom-title when multiple present', () => {
      const content = [
    ...
    it('returns null when no custom-title', () => {
      const content = [
        '{"type":"user","message":"hello"}',
        '{"type":"assistant","message":"hi"}',
      ].join('\n');
  ...
  describe('ExitPlanMode detection', () => {
    it('detects ExitPlanMode in assistant message', () => {
      const content = [
  ...
  describe('session index JSON parsing', () => {
    ...
    it('handles entry without customTitle', () => {
      const indexContent = {
        version: 1,
        entries: [
          {
