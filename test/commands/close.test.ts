...
describe('c > commands > close', () => {
  ...
  describe('signal behavior', () => {
    ...
    it('handles ESRCH (process already gone)', () => {
  ...
  describe('state transitions', () => {
    it('sets state to closed by default', () => {
      const session = createTestSession({ state: 'busy' });
    ...
    it('sets state to archived with --archive flag', () => {
      const session = createTestSession({ state: 'busy', pid: 12345 });
  ...
  describe('rejection conditions', () => {
    ...
    it('allows ending waiting session', () => {
  ...
  describe('multiple IDs', () => {
    ...
    it('continues processing after not-found ID', () => {
      const sessions = [
  ...
  describe('session lookup', () => {
    ...
    it('falls back to current directory session when no id given', () => {
      const sessions = [
