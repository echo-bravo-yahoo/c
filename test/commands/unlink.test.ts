...
describe('c > commands > unlink', () => {
  beforeEach(() => {
    resetSessionCounter();
  });

  describe('resource removal', () => {
    it('removes --pr from session', () => {
    ...
    it('removes --branch from session', () => {
      const session = createTestSession({
    ...
    it('removes multiple resources at once', () => {
      const session = createTestSession({
        resources: {
  ...
  describe('no-op behavior', () => {
    it('no-op when resource not present', () => {
