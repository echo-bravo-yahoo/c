...
describe('c > commands > find', () => {
  beforeEach(() => {
    resetSessionCounter();
  });

  describe('search fields', () => {
    it('searches session ID', () => {
  ...
  describe('case sensitivity', () => {
    ...
    it('handles mixed case in query', () => {
      const session = createTestSession({
        resources: { jira: 'MAC-123' },
      });
